    ...
    )
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'label'                      => 'Legasy sku',
                /** 'is_required' -  If required => true(1), then the attribute must have some value when you create a product. */
                'is_required'                => 0,
